...
// Admin's clinical result-entry screen — mirrors doctor-frontend's LabResultModal. Backend
// RESULT_ROLES gates this to Admin/Doctor only; Reception never sees the action that opens it.
const AdminResultModal = ({ orderId, onClose, onSaved }: { orderId: number; onClose: () => void; onSaved: () => void }) => {
