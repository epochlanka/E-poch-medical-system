...
const EnterLabResultModal = ({ order, onClose, onSaved }: EnterLabResultModalProps) => {
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <h2 className="modal-title">Enter Result</h2>
            <p className="modal-subtitle">
              {order.test_name} — LAB{String(order.lab_test_order_id).padStart(6, '0')}
            </p>
          </div>
...
export default EnterLabResultModal;
