...
INSERT INTO "new_Appointment" ("appointment_id", "created_by", "doctor_id", "patient_id", "reason", "scheduled_at", "skip_reason", "skipped_at", "status") SELECT "appointment_id", "created_by", "doctor_id", "patient_id", "reason", "scheduled_at", "skip_reason", "skipped_at", "status" FROM "Appointment";
