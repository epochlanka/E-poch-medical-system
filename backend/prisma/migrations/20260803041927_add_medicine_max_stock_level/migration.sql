...
INSERT INTO "new_Medicine" ("barcode", "buy_price", "category", "form", "generic_name", "is_active", "medicine_id", "name", "reorder_level", "strength", "unit", "unit_price") SELECT "barcode", "buy_price", "category", "form", "generic_name", "is_active", "medicine_id", "name", "reorder_level", "strength", "unit", "unit_price" FROM "Medicine";
DROP TABLE "Medicine";
