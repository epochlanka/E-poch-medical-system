...
INSERT INTO "new_Appointment" ("appointment_id", "consultation_type", "created_by", "doctor_id", "is_walk_in", "patient_id", "reason", "scheduled_at", "skip_reason", "skipped_at", "status", "visit_type") SELECT "appointment_id", "consultation_type", "created_by", "doctor_id", "is_walk_in", "patient_id", "reason", "scheduled_at", "skip_reason", "skipped_at", "status", "visit_type" FROM "Appointment";
