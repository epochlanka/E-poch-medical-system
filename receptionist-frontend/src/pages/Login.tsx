  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== 'Receptionist') {
        setError('This portal is for front-desk receptionists only. Use the main system for other roles.');
        return;
      }
    ...
    <div className="dr-auth-layout">
      ...
      <div className="dr-auth-shell">
        <div className="dr-illustration-panel">
          ...
          <h1 className="dr-welcome-title">Receptionist Portal</h1>
          <p className="dr-welcome-sub">Sign in to manage patients, the front-desk queue, and billing.</p>
        ...
        <div className="dr-form-panel">
          ...
          <p className="dr-form-sub">Enter your reception credentials to continue</p>
            ...
            <div className="dr-input-group">
              ...
              <div className="dr-input-wrapper">
                ...
                <input
                  ...
                  placeholder="Enter your reception username"
                  value={username}
...
const DeskIllustration = () => (
  <svg viewBox="0 0 320 220" width="100%" style={{ height: 'auto' }} xmlns="http://www.w3.org/2000/svg">
    <rect x="30" y="110" width="200" height="16" rx="6" fill="#c7dafc" />
    <rect x="45" y="126" width="170" height="60" rx="6" fill="#e6eefc" />
    <rect x="65" y="70" width="80" height="55" rx="6" fill="#3b82f6" />
    <rect x="72" y="77" width="66" height="38" rx="3" fill="#eaf1fd" />
    <circle cx="185" cy="95" r="22" fill="#c7dafc" />
    <circle cx="185" cy="86" r="9" fill="#3b82f6" />
    <path d="M168 118c0-10 8-18 17-18s17 8 17 18" fill="#3b82f6" />
    <rect x="150" y="145" width="18" height="24" rx="3" fill="#3b82f6" />
  </svg>
);
