    ...
    <div className="dr-auth-layout">
      ...
      <div className="dr-auth-shell">
        <div className="dr-illustration-panel">
          ...
          <h1 className="dr-welcome-title">Pharmacist Portal</h1>
          <p className="dr-welcome-sub">Sign in to manage the pharmacy queue, dispensing, and stock.</p>
        ...
        <div className="dr-form-panel">
          ...
          <p className="dr-form-sub">Enter your pharmacist credentials to continue</p>
            ...
            <div className="dr-input-group">
              ...
              <div className="dr-input-wrapper">
                ...
                <input
                  ...
                  placeholder="Enter your pharmacist username"
                  value={username}
...
const PillIllustration = () => (
  <svg viewBox="0 0 320 220" width="100%" style={{ height: 'auto' }} xmlns="http://www.w3.org/2000/svg">
    <rect x="40" y="150" width="240" height="14" rx="6" fill="#bbf7d0" />
    <rect x="95" y="60" width="130" height="70" rx="35" fill="#16a34a" transform="rotate(-25 160 95)" />
    <rect x="95" y="60" width="65" height="70" rx="35" fill="#dcfce7" transform="rotate(-25 160 95)" />
    <circle cx="90" cy="150" r="20" fill="#86efac" />
    <rect x="82" y="140" width="16" height="20" rx="4" fill="#16a34a" />
    <circle cx="230" cy="145" r="16" fill="#86efac" />
    <rect x="222" y="136" width="16" height="18" rx="4" fill="#16a34a" />
  </svg>
);

/* ---------------- Styles (scoped by dr- prefix) ---------------- */
const AUTH_STYLES = `
.dr-auth-layout { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #eef7f0; padding: 24px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; }
.dr-auth-shell { display: flex; width: 100%; max-width: 900px; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 50px rgba(22,101,52,0.12); background: white; }
.dr-illustration-panel { flex: 1; background: linear-gradient(180deg,#eafaf0,#f5fdf7); padding: 40px 36px; display: flex; flex-direction: column; }
...
.dr-logo-icon { width: 40px; height: 40px; border-radius: 10px; background: #16a34a; display: flex; align-items: center; justify-content: center; color: white; flex-shrink: 0; }
.dr-brand-text { display: flex; flex-direction: column; line-height: 1.1; }
.dr-brand-name { font-size: 18px; font-weight: 700; color: #16a34a; letter-spacing: 0.02em; }
...
.dr-input-field:focus { border-color: #16a34a; }
...
.dr-btn-primary { background: #16a34a; color: white; }
.dr-btn-primary:hover:not(:disabled) { background: #15803d; }
