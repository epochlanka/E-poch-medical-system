...
export default function BillingReports({ mode }: { mode: 'billing' | 'reports' }) {
  ...
  return <div className="ops-page">
    ...
    {mode === 'billing' ? <>
      <Notice tone="info">Use this page to check charges only — the system bills automatically once a visit is finalized and dispensing is complete. If a charge looks off, ask reception to verify it before payment.</Notice>
